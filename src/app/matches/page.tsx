  ...
  const matches = [
    { id: 1, isMonthSummary: true, month: 'April', year: 2024 },
    {
      id: 2, isMonthSummary: false, match: {
        slug: 'tot-ars',
        home: { name: 'Arsenal', logo: '', score: 2, scorers: [
          { name: 'C.Romero', minute: '68' },
          { name: 'Son Heung-Min', minute: '86', status: 'pen' },
        ]},
        away: { name: 'Tottenham Hotspurs', logo: '', score: 3, scorers: [
    ...
    },
    {
      id: 3, isMonthSummary: false, match: {
        ...
        away: { name: 'Chelsea', logo: '', score: 0},
    ...
    },
    {
      id: 4, isMonthSummary: false, match: {
        ...
        away: { name: 'Aston Villa', logo: '', score: 2 },
        venue: 'Emirates Stadium',
    ...
    },
    {
      id: 4, isMonthSummary: false, match: {
        slug: 'brit-ars',
        home: { name: 'Brighton', logo: '', score: 0 },
    ...
    },
    {
      id: 4, isMonthSummary: false, match: {
        ...
        away: { name: 'Luton Town', logo: '', score: 0 },
        venue: 'Emirates Stadium',
        started_at: new Date('2024-04-20 19:30:00'),
        competition: 'Premier League',
        competition_logo: '',
