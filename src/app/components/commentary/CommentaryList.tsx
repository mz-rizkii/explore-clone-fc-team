...
export const CommentaryList = () => {
  const comments: CommentaryByMinute[] = [
    ...
    { minute: '90', extraTime: '+5', comment: 'Corner, Tottenham Hotspur. Conceded by William Saliba'},
    { minute: '90', extraTime: '+2', comment: 'Foul by William Saliba (Arsenal).'},
    { minute: '88', icon: '/commentary/sub.png', header: 'SUBSTITUTION: KIWIOR COMES ON FOR ODEGAARD', comment: 'Substitution, Arsenal. Jakub Kiwior replaces Martin Odegaard.'},
    { minute: '86', icon: '/commentary/pen.png', isGoal: true, header: 'GOAL: SON HEUNG-MIN(PEN)', comment: `Goal. Tottenham Hotspur 2, Arsenal 3. 
    ...
    { minute: '82', icon: '/commentary/card.png', comment: 'Thomas Partey(Arsenal) is shown the yellow card for a bad foul.',
